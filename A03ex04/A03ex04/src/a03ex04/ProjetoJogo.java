 ...
 * @author mb.sampaio
 */
public class ProjetoJogo extends javax.swing.JFrame {
    private int Erros = 0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProjetoJogo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProjetoJogo().setVisible(true);
            }
        });
    }
